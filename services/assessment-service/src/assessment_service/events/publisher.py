...
ASSESSMENT_EVENTS = {"assessment.completed"}

SCHEMA_REFS = {
    "assessment.completed": "https://contracts.healuxa.com/events/assessment.schema.json#/$defs/AssessmentCompleted",
}
...
class EventPublisher:
    async def publish(
        ...
        *,
        ...
        if event_type not in ASSESSMENT_EVENTS:
