"""Assessment RBAC on default user role — assessment.openapi.yaml permissions."""
...
ASSESSMENT_PERMISSIONS = ("assessments:create", "assessments:read", "assessments:write")


@pytest.mark.asyncio
async def test_default_user_role_includes_assessment_permissions() -> None:
...
@pytest.mark.asyncio
async def test_register_introspect_includes_assessment_permissions(
    client: AsyncClient,
    service_headers: dict,
) -> None:
    email = f"assessment-rbac-{ULID()}@example.com"
