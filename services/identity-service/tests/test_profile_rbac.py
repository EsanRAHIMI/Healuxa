"""Profile RBAC on default user role — profile.openapi.yaml permissions."""
...
PROFILE_PERMISSIONS = ("profiles:read", "profiles:write")


@pytest.mark.asyncio
async def test_default_user_role_includes_profile_permissions() -> None:
...
@pytest.mark.asyncio
async def test_register_introspect_includes_profile_permissions(
    client: AsyncClient,
    service_headers: dict,
) -> None:
    email = f"profile-rbac-{ULID()}@example.com"
